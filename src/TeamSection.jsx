  ...
  return (
    <section className="team-section">
      ...
      <div className="hero-content">
        <div className="section-tag">AI • ENGINEERING • INNOVATION</div>
        <h1>
          Meet Our <span>Team</span>
        </h1>
        <div className="title-line"></div>
        <p>
          The people behind the intelligence, engineering innovative solutions for
      ...
      <div className="team-bottom">
        ...
        <p>
          Combining AI, engineering, research and creativity to solve real-world
          problems.
        </p>
      </div>
    </section>
